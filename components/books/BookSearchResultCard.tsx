...
export function BookSearchResultCard({
  ...
  return (
    <div className="flex gap-3 rounded-lg border border-zinc-800 bg-zinc-900/60 p-3 transition-colors hover:bg-zinc-900">
      ...
      <Button size="icon" variant="secondary" className="self-center" onClick={() => onAdd(result)}>
